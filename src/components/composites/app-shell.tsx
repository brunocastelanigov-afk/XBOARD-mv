...
export function AppShell({ children, title = "Dashboard", className, ...props }: AppShellProps) {
  return (
    <SidebarProvider>
      <AppSidebar />
      <div className={cn("app-shell elite-shell h-svh bg-background flex flex-col flex-1 overflow-hidden", className)} {...props}>
        ...
        <div className="shrink-0 z-30 flex items-center gap-2 border-b border-border/40 bg-background/40 backdrop-blur-xl px-4 h-14 shadow-sm">
          <SidebarTrigger />
