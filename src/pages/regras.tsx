          ...
          <form id="rule-edit-form" className="space-y-4" onSubmit={handleSubmitRule}>
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-muted-foreground">
                Nome interno para identificar esta regra na lista. Não aparece para o usuário final.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              <div className="space-y-1.5">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  Ordem de avaliação das regras: quanto menor o número, antes ela é testada.
                </p>
              </div>
              <div className="space-y-1.5">
                <Select
                ...
                <p className="text-xs text-muted-foreground">
                  Nível de resultado que o usuário recebe quando esta regra bate.
                </p>
              </div>
              <div className="space-y-1.5">
                <Select
                ...
                <p className="text-xs text-muted-foreground">
                  Override ignora as demais regras e vale sozinha quando bate; Regra padrão entra na ordem normal de prioridade.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Todas as condições abaixo precisam ser verdadeiras (E) para a regra bater. Campo = pergunta do quiz avaliada; Operador = como o valor é comparado; Valor = o que é comparado com a resposta do usuário.
              </p>
            ...
            <div className="space-y-1.5">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Nota interna opcional para explicar o propósito da regra. Aparece na lista, abaixo dela.
              </p>
            </div>
          </form>
        </EntityEditModalShell>
